...
/**
 * En esta clase se encuentra la ventana de seleccion de idioma . 
 * Donde se mostrara tres idiomas para pasar a la pantalla principal se debera
 * seleccionar el boton con el idioma correspondiente
...
public class VIdioma extends javax.swing.JFrame {
    ...
    /**
     * Constructor de la clase VIdioma. 
    ...
    /**
     * Aqui se configura la accion de cuando se presione el boton en Quechua.
     * Abre la ventana principal con la interfaz en quechua.
     *
    ...
    /**
     * Aqui se configura la accion de cuando se presione el boton en Ingles.
     * Abre la ventana principal con la interfaz en ingles.
     *
     * @param evt El evento de accion.
     */
    ...
    /**
     * Aqui se configura la accion de cuando se presione el boton en Español.
     * Abre la ventana principal con la interfaz en español.
     *
     * @param evt El evento de accion.
     */
     ...
     *
     * @param buttonName El boton que se configurará.
