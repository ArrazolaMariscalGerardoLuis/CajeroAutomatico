...
/**
 * Clase Pantalla1 que representa la interfaz gráfica para la pantalla
 * principal. Tendra dos botones uno para iniciarSesion y el otro para
 * Registrarse.
 */
public class Pantalla1 extends javax.swing.JFrame {
    ...
    /**
     * Constructor de la clase Pantalla1. Inicializa los componentes de la
     * interfaz
     *
    ...
    public Pantalla1(String idioma) {
        ...
        //Aqui se configura la direccion para la imagen del lblTitulo.
        setImageLabel(lblTitulo, "src/Imgenes/t2.png");
        lblTitulo.setOpaque(false);

        //Aqui se configura la direccion y se configura para que la imagen sea transparente en los botones.
    ...
    /**
     * Accion que se realizara al presionar el botón Atrás. Regresara a la
     * pantalla VIdioma
     *
    ...
    /**
     * Accion que se realizara al presionar el botón IniciarSesion. Pasara a la
     * pantalla IniciarSesion donde mandara como parametro idioma
     *
    ...
    /**
     * Accion que se realizara al presionar el botón Registrarse. Pasara a la
     * pantalla Registrarse donde mandara como parametro idioma
     *
     * @param evt El evento de accion.
     */
    ...
    /**
     * Aqui se configura para que el label tenga un icono dimensionado
     *
     * @param labelName El label que se configurara.
     * @param root La ruta de la imagen que se usara como icono.
     */
     ...
     *
     * @param buttonName El boton que se configurara.
