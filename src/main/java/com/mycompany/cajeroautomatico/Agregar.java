...
/**
 * Esta es la clase Agregar que representa la interfaz para cuando el usuario 
 * desee crear una nueva cuenta.
 */
public class Agregar extends javax.swing.JFrame {
    ...
    /**
     * Constructor de la clase Agregar.Inicializa los componentes de la
     * interfaz
     *
     ...
     */
    public Agregar(String ci, String cuenta, String idioma) {
        this.ci = ci;
        this.cuenta = cuenta;
        this.idioma = idioma;
     ...
     *
     * @param inicio numero con el comenzara la cuenta segun el tipo de cuenta.
     */
    ...
    /**
     * Metodo para que lea los datos del usuario cuando agregue una cuenta
     * nueva.
     *
     */
    ...
    /**
     * Metodo para guarde los datos del usuario cuando agrega una cuenta.
     *
     */
    ...
    /**
     * Metodo que guarda el carnet, numero de cuenta y la contraseña del
     * usuario.
     *
     */
    ...
    /**
     * Metodo que guarda el carnet, numero de cuenta y el saldo del usuario.
     *
     */
    ...
    /**
     * Metodo para que se desmarque los checkbox cuando el usuario haya
     * terminado de agregar su nueva cuenta y se guarde en los archivos.
     *
     */
    ...
    /**
     * Acción que se realizara al presionar el botón Cancelar. Regresara a la
     * Sesion del usuario sin agregar ninguna cuenta.
     *
    ...
    /**
     * Acción que se realizara al presionar el boton Confirmar. Regresando a la
     * sesion de usuario guardando los datos de su nueva cuenta
     *
     * @param evt Evento de accion.
     */
    ...
    /**
     * Acción que se realizara al marcar el checkbox, seleccionando Bolivianos y
     * desactivando los demas checkbox y mandando com parametro "1" a
     * generarNumeroCuenta() para asi generar el numero de la nueva cuenta del
     * usuario.
     *
     * @param evt Evento de accion.
     */
    ...
    /**
     * Acción que se realizara al marcar el checkbox, seleccionando Dolares y
     * desactivando los demas checkbox y mandando com parametro "2" a
     * generarNumeroCuenta() para asi generar el numero de la nueva cuenta del
     * usuario.
     *
     * @param evt Evento de accion.
    ...
    /**
     * Acción que se realizara al marcar el checkbox, seleccionando Euros y
     * desactivando los demas checkbox y mandando com parametro "3" a
     * generarNumeroCuenta() para asi generar el numero de la nueva cuenta del
     * usuario.
     *
     * @param evt Evento de accion.
