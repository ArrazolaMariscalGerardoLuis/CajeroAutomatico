...
/**
 * Esta es la clase Cuentas que representa la interfaz para leer todas la
 * cuentas que tiene el usuario y asi seleccionar una y pasar a la siguiente
 * pantalla.
 */
public class Cuentas extends javax.swing.JFrame {
    ...
    /**
     * Constructor de la clase Cuentas.Inicializa los componentes de la
     * interfaz
     *
    ...
    /**
     * Metodo para que lea las cuentas del usuario
     *
     * @param ci Carnet de identidad del usuario.
     */
    ...
    /**
     * Accion que se realizara al presionar el boton Salir. Pasara la pantalla
     * de VIdioma
     *
    ...
    /**
     * Accion que se realizara al seleccionar la cuenta en el comboBox. Pasara a
     * la pantalla de Sesion mandando los parametros de carnet, numero cuenta
     * del usuario y numero de cuenta del usuario, para asi poder ingresar a su
     * cuenta
     *
     * @param evt El evento de accion.
     */
