...
/**
 * Esta es la clase Hidtorisl que representa la interfaz donde se muestra el
 * historial de movimientos y el saldo de la ceunta del usuario
 */
public class Historial extends javax.swing.JFrame {
    ...
    /**
     * Constructor de la clase Historial.Inicializa los componentes de la
     * interfaz
     *
     ...
     */
    public Historial(String ci, String cuenta, String idioma) {
        this.ci = ci;
        this.cuenta = cuenta;
        this.idioma = idioma;
    ...
    private String extraerValor(String linea) {
     ...
     /**
     * Metodo para leer los movimientos de la cuenta del usuario.
     *
     */
    public void leerTransferencias() {
        try (BufferedReader br = new BufferedReader(new FileReader("src/Archivos/Movimientos.txt"))) {
            ...
            while ((linea = br.readLine()) != null) {
                if (linea.startsWith("N° DE CUENTA ORIGEN:") || linea.startsWith("N° DE CUENTA:") || linea.startsWith("A N° DE CUENTA:")) {
                    ...
                    cuentaOrigenEncontrada = cuentaOrigen.equals(cuenta);
                    envia = true;
                }
     ...
     /**
     * Metodo para consultar el saldo de la cuenta del usuario.
     *
     */
    private void consultaSaldo() {
        try (BufferedReader br = new BufferedReader(new FileReader("src/Archivos/Saldo.txt"))) {
            ...
            while ((linea = br.readLine()) != null) {
                if (linea.startsWith("N° DE CUENTA:") && extraerValor(linea).equals(cuenta)) {
                    while ((linea = br.readLine()) != null) {
