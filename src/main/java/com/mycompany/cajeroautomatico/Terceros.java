...
/**
 * Esta es la clase Terceros que representa la interfaz para la transferencia de
 * dinero a terceros donde el usuario debera proporcionar el numero de cuenta
 * para poder realizar la transaccion y asi pasar a la siguiente pantalla donde
 * debera ingresar el monto que desee transferir
 */
public class Terceros extends javax.swing.JFrame {
    ...
    /**
     * Constructor de la clase Terceros.Inicializa los componentes de la
     * interfaz
     *
    ...
    /**
     * Accion que se realizara al presionar el boton Confirmar. Pasara la
     * pantalla de Transaferir mandando los parametros de carnet, numero cuenta
     * del usuario y numero de cuenta del que se realizara la transferencia
     *
    ...
    /**
     * Acción que se realizara al presionar el boton Atras. Regresara a la
     * Pantalla ElegirT mandano los parametro de carnet, numero de cuenta del
     * usuario y el idioma
     *
