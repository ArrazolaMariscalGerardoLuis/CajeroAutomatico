...
/**
 * Esta es la clase Propias que representa la interfaz de cuando el usuario
 * quiera hacer transferencia a una de sus cuentas
 */
public class Propias extends javax.swing.JFrame {
    ...
    /**
     * Constructor de la clase Propias.Inicializa los componentes de la interfaz
     *
    ...
    /**
     * Metodo para que lea las cuentas del usuario para que pueda realizar la
     * transferencia
     *
     */
    ...
    /**
     * Accion que se realizara al seleccionar una cuenta en el jComboBox. Pasara
     * la pantalla de Transaferir mandando los parametros de carnet, numero
     * cuenta del usuario y numero de cuenta del que se realizara la
     * transferencia y el idioma
     *
